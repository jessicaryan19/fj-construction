...
export default function PartnershipSection() {
    return (
        <div className="flex flex-col lg:flex-row gap-14 w-full container">
            <VerticalFadeIn className="w-full lg:flex-none lg:w-1/3 h-64 md:h-96 lg:h-auto rounded-3xl overflow-hidden bg-white">
                <ImageRoundedCard source="/services/partnership.jpg" />
            </VerticalFadeIn>

            <div className="flex-1 flex flex-col gap-12 text-primary h-full">
                <h5>Why You Should Partner With Us</h5>
