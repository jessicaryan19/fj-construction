...
export default function ProjectHero({
    ...
    return (
        <ImageBackground image={`/projects/${project.id}/${project.landingCover}`} opacity={30}>
            <div className="flex flex-col items-center justify-end min-h-screen pb-10 md:pb-20 pt-40 sm:pt-64">
                <div className="container flex flex-col flex-1 gap-10 md:gap-0 md:justify-between px-4">
