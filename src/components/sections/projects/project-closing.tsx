...
export default function ProjectClosing() {
    return (
        <ImageCTE image="/services/handshake.jpg">
            <h2 className="text-white text-center">Your Vision, Our Expertise.</h2>
            <h4 className="text-white text-center">Strong foundations start with strong partnerships.</h4>
